...
MAX44009_REG_CONFIGURATION = const(0x02)
MAX44009_REG_LUX_HIGH_BYTE = const(0x03)
MAX44009_REG_LUX_LOW_BYTE  = const(0x04)
...
class MAX44009:
    ...
    def configuration(self, value):
        self._config = value
        self.i2c.writeto_mem(self.address, MAX44009_REG_CONFIGURATION, bytes(self._config))

    @property
    def illuminance_lux(self):
        data = self.i2c.readfrom_mem(self.address, MAX44009_REG_LUX_HIGH_BYTE, 2)
